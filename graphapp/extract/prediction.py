...
def predict(image):
    ...
    print("Probablity of being Extroverted: ",
          round(probability2[0][1]*100), "%")
    print("Probablity of being Introverted : ",
          round(probability2[0][2]*100), "%")
...
# prediction["prediction"]["behaviour_type"]["outgoing"]
# prediction["prediction"]["personalirt_type"]
# prediction["calculation"]["slant"]
